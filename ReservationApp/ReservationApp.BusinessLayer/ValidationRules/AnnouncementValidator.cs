...
namespace ReservationApp.BusinessLayer.ValidationRules
{
    public class AnnouncementValidator: AbstractValidator<AnnouncementAddDTO>
    {
        public AnnouncementValidator()
        {
            ...
            RuleFor(x => x.Content).MinimumLength(20).WithMessage("Lütfen en az 20 karakter girişi yapın!");
            RuleFor(x => x.Content).MaximumLength(500).WithMessage("Lütfen en fazla 500 karakter girişi yapın!");
